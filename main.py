...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # self.ui.enrol_face_but.pressed.connect(self.ui.test)
...
class SplashScreen(QMainWindow):
    def __init__(self):
        ...
        # Initial Text
        #self.ui.label_title.setGeometry((QRect(0, 70, 661, 61)))
        ...
        QtCore.QTimer.singleShot(2300, lambda: self.ui.label_description.setText(
            "<strong>LOADING</strong> FACIAL RECOGNITION"))
